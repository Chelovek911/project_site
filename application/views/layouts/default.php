...
<header>
    <div class="top">
        <div class="navbar container1 <?php
            ...
            <a href="/" class="logo"><img src="public\images\about\logo-midex.png" style="border-style: none; max-width: 100%;"></a>
            <div class="menu_icon">
                <span></span>
            </div>
            <div class="allnav">
                <div class="allmenu">
                    <div class="dropdown1 pb-3 pt-3" style="height: 100%;">
                        <button id="open-button" class="dropbtn1 <?php
                                                                    ...
                                                                    if ($_SERVER['REQUEST_URI'] == '/') {
                                                                        echo 'bg_2';
                                                                    } else echo 'bg-light'  ?>  ">О компании</button>
                    ...
                    <div class="dropdown1 pb-3 pt-3">
                        <button class="dropbtn1 <?php
                                                ...
                                                if ($_SERVER['REQUEST_URI'] == '/') {
                                                    echo 'bg_2';
                                                } else echo 'bg-light'  ?>  ">Продукция</button>
                    ...
                    <div class="dropdown1 pb-2 pt-3">
                        ...
                        <button onclick="myFunction()" class=" dropbtn2  <?php
                                                                            ...
                                                                            if ($_SERVER['REQUEST_URI'] == '/') {
                                                                                echo 'bg_2';
                                                                            } else echo 'bg-light'  ?>  "><img name='img' src="public\images\about\ico_logo_poloskun.png"></button>
